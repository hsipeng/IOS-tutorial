...
# np.array 处理 <calss int>无法处理
x_val = np.array(train_data[:100000])
partial_x_train = np.array(train_data[100000:])
y_val = np.array(train_labels[:100000])
partial_y_train = np.array(train_labels[100000:])
